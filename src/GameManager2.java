...
public class GameManager2 extends InputTest {
	
	public static void main(String args[]){
		new GameManager2().run();
	}
	
	private PlaylistMP3 playlist;
	...
	public void init(){
		...
		playlist = new PlaylistMP3(false);
		playlist.start();
...
public void acquirePowerUp(PowerUp powerUp) {
    ...
    if (powerUp instanceof PowerUp.Jump){
    	...
    	playlist.stopPlaying();
    	musicMode = !musicMode;    	
    	playlist = new PlaylistMP3(musicMode);
		playlist.continuePlaying();
		playlist.start();
	}
